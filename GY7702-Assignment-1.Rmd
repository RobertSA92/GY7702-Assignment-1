---
title: "209045062_GY7702_CW1_Programming_Exercise"
...
seven_day_average_5_areas <- lad19_covid19 %>%
  ...
  dplyr::select(-cumCasesBySpecimenDate, -area_population, -lad19_area_code) %>%
  ...
  dplyr::group_by(week_commencing) %>%
  
  # Find the 7-day average of new cases for each selected area. 
  dplyr::summarise(Powys = mean(Powys),
